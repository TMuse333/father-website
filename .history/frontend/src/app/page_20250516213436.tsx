    ...
    <div className="min-h-screen bg-gray-100 relative text-black flex flex-col">
      ...
      <header className="relative w-full">
        ...
        bg-red-200">
          ...
          <div className="text-center sm:text-left flex md:flex-row w-screen
          justify-between items-center
          bg-red-200
          h-[100px]">
            {/* <p>Chris Musial, B.A, REALTOR®</p>
            <p className="text-sm text-gray-600">RE/MAX NOVA</p>
            <p className="text-sm">5943 Spring Garden Road, Halifax, Nova Scotia B3H 1Y4</p>
            <p className="text-sm ml-auto">(902) 876-8000 | Musial.Chris@gmail.com</p> */}
          </div>
