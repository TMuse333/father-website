  ...
  return (
    <div className="min-h-screen bg-gray-100 text-black flex flex-col relative">
      ...
      <header className="relative z-10 bg-white">
        ...
        <div className="max-w-7xl mx-auto pt-6 flex flex-col sm:flex-row justify-between items-center bg-white shadow
        max-w-[1200px] bg-blue-200">
          <div className="flex flex-col  bg-blue-100 md:flex-row justify-between items-center w-full px-4 text-center">
