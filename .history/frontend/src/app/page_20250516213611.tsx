      ...
      <header className="relative w-full">
        ...
        bg-red-200">
          ...
          h-[100px]">
            ...
            <p className="text-2xs text-gray-600">RE/MAX NOVA</p>
            <p className="text-2xs">5943 Spring Garden Road, Halifax, Nova Scotia B3H 1Y4</p>
            <p className="text-2xs ">(902) 876-8000 | Musial.Chris@gmail.com</p>
          </div>
