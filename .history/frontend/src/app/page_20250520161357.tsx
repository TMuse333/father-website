  ...
  return (
    <div className="min-h-screen bg-gray-100 relative text-black flex flex-col">
      ...
      <header className="relative w-full">
        ...
        bg-red-200">
          ...
          ">
            ...
            text-xs text-left md:text-center
            md:w-1/2 justify-around'>
            ...
            px-4 md:text-center md:w-1/2 justify-around'>
      ...
      <div className="relative flex-1 w-full">
        <Image
          src="/portrait.png" // Replace with your cityscape image path
          alt="Cityscape"
          fill
        ...
        <div className="relative z-10">
          ...
          {/* Brochure Section */}
          <section className="w-screen flex flex-col gap-12
          ">
          {/* <h2 className='text-4xl relative z-2'>Hello!</h2> */}
            <div className="relative h-64 mr-auto">
              <Image
                src="/home.png" // Replace with your "Home Buyer's Course" image path
                alt="Home Buyer's Course"
                fill
                className="object-cover rounded-lg
                w-[70vw] mx-auto object-cover
                max-w-[200px] md:mr-auto"
              />
            </div>
            <div className="relative h-64">
              <Image
                 src="/buyer.png" // Replace with your "Selling My Home" image path
                alt="Selling My Home"
                fill
                className="object-cover rounded-lg
                w-[70vw] mx-auto object-cover
            ...
            <div className="relative h-64">
              <Image
                 src="/condo.png" // Replace with your "Selling My Condominium" image path
